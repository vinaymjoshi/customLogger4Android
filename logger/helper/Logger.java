package com.unikve.codelibraryproject.logger.helper;
...
import com.unikve.codelibraryproject.logger.LogUtils;
    ...
    public void alert(final Context context, Object object) {
        ...
        if (null == dialog) {
            dialog = new AlertDialog.Builder(context)
                    .setNegativeButton(LogUtils.COPY, listener)
                    .setPositiveButton(LogUtils.CANCEL, listener)
                    .create();
        ...
        public void onClick(DialogInterface dialogInterface, int which) {
            ...
            switch (which) {
                case DialogInterface.BUTTON_NEGATIVE:
                    ...
                    Toast.makeText(context,LogUtils.COPY_SUCCESS, Toast.LENGTH_LONG).show();
                    break;
